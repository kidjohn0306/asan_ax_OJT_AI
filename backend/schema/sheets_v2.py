...
SHEET_HEADERS: dict[str, tuple[str, ...]] = {
    ...
    "users": _headers("employee_id|password_hash|name|team|role|approved|shift_type|process_code|task_code|is_active|approved_by|approved_date|created_at|updated_at|row_version|department|employment_status|last_login_at"),
