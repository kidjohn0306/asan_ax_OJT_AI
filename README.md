...
│   └── question_generator.py # Claude API 연동 + mock 생성기(_mock_generate) 겸용 ✅
├── frontend/
...
| `ai_engine/question_generator.py` | ✅ 완료 | Claude API(`claude-sonnet-5`, anthropic SDK) 문제 생성, mock 생성기 겸용 |
...
| 기능 | 파일 | 비고 |
|---|---|---|
| ~~Claude API 문제 생성~~ | ~~`ai_engine/question_generator.py`~~ | ✅ 구현 완료 |
...
- [x] Claude API 문제 생성 (`question_generator.py`)
